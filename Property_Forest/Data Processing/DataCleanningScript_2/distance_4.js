...
connection.query('SELECT * FROM resale_prices.resale_hdb where nearest_mrt is NULL and id<200000 order by id desc LIMIT 1;', function(hdb_err, hdb_rows, hdb_fields) {
